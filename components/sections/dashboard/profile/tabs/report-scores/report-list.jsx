          ...
          <div className="flex items-center border-b border-gray-200">
            <div className="flex-shrink-0 p-2 mr-4">
              <div
                ...
                style={{
                  background: "rgba(4, 138, 226, 0.15)",
                }}
              >
                <Image
            ...
            <div className="flex-shrink-0">
              <button className="p-2 bg-sky-500 rounded text-white text-[10px] font-semibold leading-none hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-1">
                View Details
              </button>
            </div>
          </div>
