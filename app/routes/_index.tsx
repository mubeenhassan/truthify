...
function ButtonLink({
  ...
  return (
    <Link to={to} className={`${baseStyle} ${variantStyle} ${className}`}>
      {children}
...
export default function Index() {
  ...
  return (
    <div className="bg-white font-['Inter'] text-zinc-800">
      {/* --- Header --- */}
      <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur-sm">
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8 h-20">
          <div className="flex items-center gap-12">
            <Link to="/" className="-m-1.5 p-1.5">
              ...
              <img
                ...
                src="/truthify-logo.png" // Use your logo path
                alt="Truthify Logo"
              />
            </Link>
            <div className="hidden lg:flex lg:gap-x-12">
              {/* Add dropdown logic if needed for Scores */}
              <Link
                to="/scores"
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              to="/signup"
              className="rounded-md bg-sky-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-sky-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 inline-flex items-center gap-2"
            >
              Sign Up Now
        ...
        {/* Add Mobile menu content here, potentially using state */}
      </header>
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1 self-center">
                ...
                <p className="mt-6 text-lg leading-8 text-zinc-700">
                  {" "}
                  We use AI to analyze an individual's statements and measure
                  them for reliability and consistency.{" "}
                </p>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="lg:w-1/2 lg:pr-8">
              ...
              <div className="max-w-xl">
                ...
                <div className="mt-10">
                  {" "}
                  <ButtonLink to="/signup" variant="white">
                    Subscribe Now
                  </ButtonLink>{" "}
                </div>
              </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8 grid lg:grid-cols-2 gap-16 xl:gap-24 items-center">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-6 text-lg leading-7 text-zinc-700">
                ...
                cutting-edge AI and machine learning, our platform detects
                blatant falsehoods, contradictions, fallacies, and more,
                empowering users with deeper insights and stronger reasoning.
              </p>
            ...
            <div className="grid grid-cols-1 gap-x-16 gap-y-10 lg:grid-cols-2 items-start">
              ...
              <div>
                ...
                <p className="mt-6 text-lg leading-7 opacity-90">
                  Unlock the full potential of AI-driven analysis with over
                  1,000 unique reports designed to evaluate truth, logic,
                  consistency, and integrity in any content. Whether you're
                  fact-checking, analyzing arguments, or refining your own
                  reasoning, our system provides deep insights tailored to your
                  needs.
                </p>
                <div className="mt-10">
                  <ButtonLink to="/signup" variant="white">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
              ...
              <div className="max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1 self-center">
                ...
                <p className="mt-6 text-lg leading-7 text-zinc-700">
                  With a seamless onboarding process, user-friendly interface,
                  and AI-powered automation, you'll be generating insights in no
                  time. No complex training required—just powerful analysis at
                  your fingertips.
                </p>
              </div>
